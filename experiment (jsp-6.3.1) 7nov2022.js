...
var group_assignment = {
  ...
  stimulus: function () {
    ...
    return (
      ...
      and 40 people in the <span style="color:red;">${other_team}</span> group.
      ...
      <br><br><b>Press "n" to continue.</b></div>`
    );
  },
  choices: ["n"]
};
...
var instructions_all_block = {
  ...
  At any point, you may press "n" to continue, unless another action is required.
...
var coop_comparison_block_placeholder = {
  type: "html-keyboard-response",
  stimulus: function() {
    var stim;
    // characterize cooperativeness of counterpart based on experimental condition
...
var fruit_prompt = {
  type: 'html-keyboard-response',
  stimulus: `<p>On the next page, please indicate which fruit you enjoy the most of the listed options.</p><p><b>Press "n" to continue.</b></p>`,
  choices: ["n"],
...
var color_prompt = {
  type: 'html-keyboard-response',
  stimulus: '<p>On the next page, please indicate which color you prefer of the listed options.</p><p><b>Press "n" to continue.</b></p>',
  choices: ["n"],
  trial_duration: 10000
}
...
var flavor_prompt = {
  type: 'html-keyboard-response',
  stimulus: '<p>On the next page, please indicate which flavor you prefer of the listed options.</p><p><b>Press "n" to continue.</b></p>',
  choices: ["n"],
  trial_duration: 10000
}
