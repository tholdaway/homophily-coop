...
Qualtrics.SurveyEngine.addOnload(function () {
    ...
    function nfl_team_info(fav_team) {
      ...
      var dict = {'Arizona Cardinals' : { colors : ['#97233F', '#000000'],
                  ...
                  low    : { counterp : 'LA Chargers', counterp_colors : ['#0080C6', '#FFC20E'] },
                  high   : { counterp : 'Pittsburgh Steelers', counterp_colors : ['#000000', '#FFB612'] } },
                  'Buffalo Bills' : { colors : ['#00338D', '#C60C30'],
                  low    : { counterp : 'Indianapolis Colts', counterp_colors : ['#013369', '#1D252C'] },
                  ...
                  low    : { counterp : 'New York Jets', counterp_colors : ['#115740', '#000000'] },
                  high   : { counterp : 'Pittsburgh Steelers', counterp_colors : ['#000000', '#FFB612'] } },
                  ...
                  low    : { counterp : 'New England Patriots', counterp_colors : ['#002244', '#C60C30'] },
                  high   : { counterp : 'Green Bay Packers', counterp_colors : ['#203731', '#FFB612'] } },
                  'Green Bay Packers' : { colors : ['#203731', '#FFB612'],
                  low    : { counterp : 'Tampa Bay Buccaneers', counterp_colors : ['#A71930', '#322F2B'] },
                  high   : { counterp : 'Chicago Bears', counterp_colors : ['#0B162A', '#E64100'] } },
                  'Houston Texans' : { colors : ['#03202F', '#A71930'],
                  low    : { counterp : 'New Orleans Saints', counterp_colors : ['#000000', '#D3BC8D'] },
                  ...
                  low    : { counterp : 'Atlanta Falcons', counterp_colors : ['#000000', '#A71930'] },
                  ...
                  low    : { counterp : 'Jacksonville Jaguars', counterp_colors : ['#006778', '#000000'] },
